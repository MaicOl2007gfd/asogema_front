...
const whatsappLink = computed(() => {
  const number = String(WHATSAPP_NUMBER || '').replace(/[^0-9]/g, '')
  const text = encodeURIComponent(WHATSAPP_MESSAGE || 'Hola Asogema, quiero más información.')
...
<template>
  <div class="index-page">
    ...
    >
      ...
      <span class="wa-float-tooltip">¿Hablamos?</span>
    </a>
