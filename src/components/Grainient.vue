...
const props = defineProps({
  ...
  color1: { type: String, default: '#2d5a2e' },
  color2: { type: String, default: '#133215' },
  color3: { type: String, default: '#0b1f0d' },
...
<template>
  <div ref="containerRef" :class="['grainient-container', className]" />
</template>
